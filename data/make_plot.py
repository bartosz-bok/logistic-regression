...
axs[0].scatter(X_2[:, 0], X_2[:, 1], c=y_2, s=10, cmap=plt.cm.coolwarm, edgecolors='black',)
axs[1].scatter(X_3[:, 0], X_3[:, 1], c=y_3, s=10, cmap=plt.cm.coolwarm, edgecolors='black',)
axs[2].scatter(X_7[:, 0], X_7[:, 1], c=y_7, s=10, cmap=plt.cm.coolwarm, edgecolors='black',)
